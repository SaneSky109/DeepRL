...
class Player:
    ...
    def __init__(self, game):
        ...
        self.bullet_cooldown_frames = 10
    ...
    def shoot(self):
        ...
        if self.frame_counter - self.last_bullet_frame >= self.bullet_cooldown_frames:
            self.last_bullet_frame = self.frame_counter  # Update the last bullet time
