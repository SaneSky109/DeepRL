...
model_path = f'{folder_path}/model_episode_350_ten_asteroids_movement_incentive.h5'
training_state_path = f'{folder_path}/model_episode_350_ten_asteroids_movement_incentive_training_state.json'
