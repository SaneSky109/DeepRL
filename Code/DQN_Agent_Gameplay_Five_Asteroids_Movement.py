...
class Game:
    ...
    def get_reward(self):
        ...
        reward += self.score * 10  # Assuming self.score is incremented elsewhere in the code when an asteroid is 
...
model = load_model(f'{folder_path}/model_episode_500_ten_asteroids_movement_incentive.h5')
