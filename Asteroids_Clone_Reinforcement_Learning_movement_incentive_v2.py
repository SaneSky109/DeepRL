...
EPISODES = 500
SAVE_INTERVAL = 50  # Save the model every 50 episodes
RENDER_EVERY_N_EPISODES = 50  # Adjust this number based on your preference
...
for episode in range(1, EPISODES + 1):
    ...
    for time in range(1, 2001):
        ...
        if time == 2000:  # This is your maximum step limit
        ...
        if done:
            ...
            print(f"Episode: {episode}/{EPISODES}, score: {round(total_reward, 2)}, e: {agent.epsilon:.2}")
            break
