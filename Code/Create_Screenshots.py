    ...
    def __init__(self, state_size, action_size, replay_buffer_size=100000, update_target_every=5, model_file_path = None, training_state_file_path = None):
        ...
        if training_state_file_path:
            with open(training_state_file_path, 'r') as f:
                ...
                self.epsilon = training_state['state']
...
# model = load_model(f'{folder_path}/model_episode_625_ten_asteroids_movement_incentive.h5')
model = load_model('C:/Users/ericl/OneDrive/Documents/ReinforcementLearning/DQN_Models/model_episode_1500_ten_asteroids_movement_incentive.h5')
