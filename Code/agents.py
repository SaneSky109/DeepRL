...
class DQNAgent:
    def __init__(self, state_size, action_size, replay_buffer_size=100000, update_target_every=5, model_file_path = None, training_state_file_path = None, replay_buffer_file_path = None, evaluation = False):
    ...
    def save_best_model_reward(self, file_path, reward):
        with open(file_path, 'w') as f:
